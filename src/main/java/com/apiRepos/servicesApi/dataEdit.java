...
public class dataEdit {
  ...
  final static Logger logger = Logger.getLogger(dataEdit.class);
  ...
  public void updateData() {
    ...
    System.out.print("Enter the updated name of the contact : ");
    ...
    System.out.print("Enter the updated Mobile number of the contact : ");
    scanner: while (scanner.hasNext()) {
      if (scanner.hasNextInt()) {
        ...
        if (isValidFormat(Mobile2)) {
          ...
          System.out.println("ERROR: Input not correct format (e.g.(85)12345) at the "
    ...
    System.out.print("Enter updated office number of the contact : ");
    scanner: while (scanner.hasNext()) {
      if (scanner.hasNextInt()) {
    ...
    phoneUpdater.updateOneContact(id, Name.toUpperCase(), Mobile, Office, Stars);
